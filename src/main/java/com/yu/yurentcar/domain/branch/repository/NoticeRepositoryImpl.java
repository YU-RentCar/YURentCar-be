...
public class NoticeRepositoryImpl implements NoticeRepositoryCustom {
    ...
    @Override
    public List<NoticeListResponseDto> getNoticesByBranchName(SiDoType siDo, String branchName, Integer count) {
        //notice 조회
        //지점네임을 던져줌
        ...
        return queryFactory
                .select(Projections.constructor(NoticeListResponseDto.class, notice.noticeId, notice.photoUrl, notice.title, notice.description, notice.startDate, notice.finishDate, notice.modifiedAt))
                .from(notice)

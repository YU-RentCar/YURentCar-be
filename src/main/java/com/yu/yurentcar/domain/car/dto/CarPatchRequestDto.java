...
public class CarPatchRequestDto {
    ...
    public static CarRequestDto toCarRequestDto(CarPatchRequestDto carPatchRequestDto) {
        return CarRequestDto.builder()
                .carNumber(carPatchRequestDto.getCarNumber())
                .totalDistance(carPatchRequestDto.getTotalDistance())
                .carPrice(carPatchRequestDto.getCarPrice())
                .discountRate(carPatchRequestDto.discountRate)
                .discountReason(carPatchRequestDto.discountReason)
                .carDescription(carPatchRequestDto.carDescription)
                .carName(carPatchRequestDto.getCarName())
                .maxPassenger(carPatchRequestDto.getMaxPassenger())
                .carSize(carPatchRequestDto.getCarSize())
                .oilType(carPatchRequestDto.oilType)
                .transmission(carPatchRequestDto.getTransmission())
                .isKorean(carPatchRequestDto.isKorean)
                .carBrand(carPatchRequestDto.getCarBrand())
                .releaseDate(carPatchRequestDto.getReleaseDate())
                .repairList(carPatchRequestDto.getRepairList())
                .accidentList(carPatchRequestDto.getAccidentList())
                .build();
    }
}